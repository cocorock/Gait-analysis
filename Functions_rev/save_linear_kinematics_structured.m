%% save_linear_kinematics_structured: Saves the calculated linear kinematics data in a structured format.
%
% Credits:
...
%   and velocity) to a .mat file in the 'Gait Data' directory.
%
% Input:
...
%     data = create_linear_kinematics_structure(linear_kinematics); 
    save(filename, 'data');
